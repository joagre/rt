...
void system_enable_gpio(char port) {
    switch (port) {
        case 'A': case 'a': RCC_AHB1ENR |= RCC_AHB1ENR_GPIOAEN; break;
        case 'B': case 'b': RCC_AHB1ENR |= RCC_AHB1ENR_GPIOBEN; break;
        case 'C': case 'c': RCC_AHB1ENR |= RCC_AHB1ENR_GPIOCEN; break;
        case 'D': case 'd': RCC_AHB1ENR |= RCC_AHB1ENR_GPIODEN; break;
        case 'E': case 'e': RCC_AHB1ENR |= RCC_AHB1ENR_GPIOEEN; break;
        case 'H': case 'h': RCC_AHB1ENR |= RCC_AHB1ENR_GPIOHEN; break;
    }
}
