...
#include <stdint.h>
#include <stdbool.h>
#include "platform_types.h"  // Shared types: platform_state_t, platform_sensors_t, platform_motors_t

// Loop timing configuration (PLATFORM_LOOP_* defined in platform_types.h)
